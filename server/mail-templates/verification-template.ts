const verifyEmail = function (otp: string) {
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style=" background-image: url(https://bmsstatic.adjarabetarena.com/html/BMS/html5/adjarabetarena/email/bg.png ); background-repeat: repeat; ">
                    ...
                    <tr>
                        <td align="center" width="100%" height="200">
                            <table width="100%">
                                <tr>
                                    <td align="center"><span><img src="https://bmsstatic.adjarabetarena.com/html/BMS/html5/adjarabetarena/email/code5.jpg" alt="" border="0" width="360" height="20" style="border:none; outline:none;"></span><br><br><span style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size:22px; color: #9b9b9b; font-weight: bold;">${otp}</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    const text = `adjarabetarena.com | შენი ვერიფიკაციის კოდი  - ${otp}`;
